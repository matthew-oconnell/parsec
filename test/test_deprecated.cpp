...
TEST_CASE("deprecated property is reported during validation", "[validate][deprecated]") {
    ...
    serverPortProp["description"] = "DEPRECATED: Use 'port' instead. This property will be removed in v2.0.";
...
TEST_CASE("deprecated enum value in oneOf is reported", "[validate][deprecated][enum]") {
    ...
    deprecatedBC["description"] = "DEPRECATED: Use 'supersonic inflow' instead. Renamed for clarity.";
